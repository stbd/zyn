...
class TestResponse(unittest.TestCase):
    ...
    def test_get_field(self):
        rsp = self._response_ok_with_uint_field()
        self.assertEqual(rsp.get_field(0).as_uint(), 5)
    ...
    def test_get_item_list(self):
        ...
        values = rsp.get_field(0).as_list()
...
class TestNotification(unittest.TestCase):
    ...
    def _notification_with_uint_field(self):
        return self._create_notification('V:1;NOTIFICATION:;U:5;E:;')
    ...
    def test_get_field(self):
        n = self._notification_with_uint_field()
        self.assertEqual(n.get_field(0).as_uint(), 5)
